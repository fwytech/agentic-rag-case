...
**代码文件：** `study-agentic-rag/03-smart-qa-application/utils/chat_history.py`
...
**代码文件：** `study-agentic-rag/03-smart-qa-application/utils/decorators.py`
...
4. **为什么限制返回值字符串长度？**
   ...
   - 日志文件不应该被大量数据撑爆
   - 500字符足够调试
**代码文件：** `study-agentic-rag/03-smart-qa-application/utils/ui_components.py`
